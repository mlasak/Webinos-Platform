...
// Implementation of the tv module API for the Coolstream STB
...
(function () {
    ...
    TVDisplayManager.prototype.setChannel = function (channel, successCallback, errorCallback) {
    	STB.zapto(channel.name,function(){
